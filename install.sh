...
copy_dir "config/mise" "$HOME/.config/mise"
copy_dir "config/opencode" "$HOME/.config/opencode"
copy_dir "config/ghostty" "$HOME/.config/ghostty"
copy_dir "config/nvim" "$HOME/.config/nvim"
copy_dir "config/psql" "$HOME/.config/psql"
copy_dir "config/television" "$HOME/.config/television"
...
copy_dir "config/claude/skills" "$HOME/.claude/skills"
